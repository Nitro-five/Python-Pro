...
<dt>
    <h4 class="name" id="curve"><span class="type-signature"></span>curve<span class="signature">(ctx, points, <span class="optional">tension</span>, <span class="optional">numOfSeg</span>, <span class="optional">close</span>)</span><span class="type-signature"> &rarr; {Float32Array}</span></h4>
...
<dt>
    <h4 class="name" id="getCurvePoints"><span class="type-signature"></span>getCurvePoints<span class="signature">(points, <span class="optional">tension</span>, <span class="optional">numOfSeg</span>, <span class="optional">close</span>)</span><span class="type-signature"> &rarr; {Float32Array}</span></h4>
