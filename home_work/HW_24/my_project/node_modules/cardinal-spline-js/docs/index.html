...
<div class="container-fluid">
    ...
    <section class="readme-section">
        <article><h1>﻿Cardinal spline</h1><p>A Cardinal spline (basically a Catmull-Rom with a tension option)<br>implementation for  JavaScript/HTML5 which creates an interpolated<br>smooth curve through each point pair in the given array. There is no<br>need to specify control points.</p>
<p><img src="https://i.imgur.com/5e69T5C.png" alt="Demo snapshot"></p>
...
<h1>Install</h1><ul>
<li>Git using HTTPS: <code>git clone https://gitlab.com/epistemex/cardinal-spline-js.git</code></li>
<li>Git using SSH: <code>git clone git@gitlab.com:epistemex/cardinal-spline-js.git</code></li>
<li>NPM: <code>npm install cardinal-spline-js</code> (curve_calc.js / curve_func.js)</li>
</ul>
...
<h1>License</h1><p>Released under <a href="http://choosealicense.com/licenses/mit/">MIT license</a>.</p>
<p><em>&copy; 2013-2018 Epistemex</em></p>
<p><img src="https://i.imgur.com/wZSsyt8.png" alt="Epistemex"></p></article>
    </section>
				...
				<footer>
					...
					<p><b><a href='https://gitlab.com/epistemex/'>Epistemex at GitLab</a></b></p>
					<br />
					
					
		<span class="copyright">
		Copyright &copy; 2013-2018 Epistemex
		</span>
					<br />
					
		<span class="jsdoc-message">
		Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.5.5</a>
		on Wed Jul 11th 2018 using the <a
