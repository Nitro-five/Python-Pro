...
'''
важно контролировать входные значения цены, я бы выбрал @property, 
поскольку он обеспечивает хороший баланс между простотой и функциональностью, 
сохраняя читабельность кода.
'''